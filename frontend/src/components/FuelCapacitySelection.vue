      ...
      <b-tabs card>
        <b-tab v-for="(fuel) in fuels" :key="fuel.name" :title="fuel.name"
          ...
          <div class="content-container">
              ...
              <table class="fuel-table">
                ...
                <tbody>
                  <tr v-for="(row, rowIndex) in fuel.rows" :key="rowIndex">
                    ...
                    <td>
                      <b-button size="sm" variant="danger" @click="removeRow(fuel, rowIndex)">
                        Remove
                      </b-button>
                    </td>
                  </tr>
            ...
            <!-- Add Row Button -->
            <b-button size="sm" variant="success" class="mt-2" @click="addRow(fuel)">
              New tanker capacity
            </b-button>
...
export default {
  ...
  computed: {
    fuels() {
      return this.localData.fuelCapacitySelection.fuels;
    },
  },
  watch: {
